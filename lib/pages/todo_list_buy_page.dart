...
import 'package:lista_de_contas/repository/todo_buy_repository.dart';
import 'package:lista_de_contas/widgets/todo_list_item.dart';

class TodoListBuyPage extends StatefulWidget {
  const TodoListBuyPage({super.key});

  @override
  State<TodoListBuyPage> createState() => _TodoListBuyPageState();
}

class _TodoListBuyPageState extends State<TodoListBuyPage> {
  final TextEditingController todoController = TextEditingController();
  final TodoBuyRepository todoRepository = TodoBuyRepository();
  List<Todo> todos = [];
  String categorie = "Pagamentos";
